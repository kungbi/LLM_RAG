...
def main():
    ...
    if prompt := st.chat_input():
        ...
        with st.chat_message("assistant"):
            ...
            full_response = {"result": False, "sql": False, "query": "", "sql_result": "", "message": ""}
            ...
            for response in response_generator:
                ...
                if response["result"] is False:
                    ...
                    try:
                        db_execute_result = db_api.execute(config_options[selected_config], sql_response)

                        if db_execute_result["result"]:
                            full_response["result"] = True
                            full_response["sql"] = True
                            sql_result = db_execute_result["sql_result"]
                            pretty_string = tabulate(sql_result, headers="keys", tablefmt="psql")
